...
<head>
   ...
   <link rel="shortcut icon" href="./images/plant 1.png" type="image/x-icon">
    ...
    <link rel="stylesheet" href="{{ asset('backendstyle/css/login.css') }}">
          ...
          <div class="liftmanu">
            <ul class="d-flex align-items-center ">
             ...
             <ul class="categorySubmenu">
              ...
              <li><a class="active1" href="./shop.html">Shop<iconify-icon icon="fe:arrow-down" width="24" height="24"></iconify-icon></a></li>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-5"> <div class="login-container">
        <h1>Sign In</h1>
        <form id="loginForm" action="{{ route('customer.login.submit') }}" method="POST">
            ...
            <div class="options">
                ...
                <a href="{{ route('customer.password.forgot') }}" class="forgot-password">Forget Password</a>
            </div>
            <button type="submit" class="login-btn">Login</button>
        </form>
        <div class="row my-3">
            <div class="col-lg-6 socialdiv">
                <a href="{{ url('auth/facebook') }}" class="social-btn">
                    <img width="40px" src="{{ asset('frontendstyle/images/1024612.png') }}" alt="">
                    <span> Continu with facebook</span>
            </a></div>
            <div class="col-lg-6">
                <a href="{{ route('google.login') }}" class="social-btn">
                    <img width="40px" src="{{ asset('frontendstyle/images/7611770.png') }}" alt="">
                    <span> Continu with Google</span>
            </a>
        </div>
            
        </div>
        <div class="register-link">
            Don't have account? <a href="{{ route('customer.register') }}">Register</a>
        </div>
    </div>
...
<footer class="shopery-footer">
  <div class="container">
    ...
    {{-- <script src="{{ asset('backendstyle/js/login.js') }}"></script> --}}
</body>
</html>