...
<body>
                    ...
                    <div class="col-lg-9">
                        <div class="liftmanu">
                            <ul class="d-flex align-items-center ">
                                ...
                                <li><a href="./homepage4.html">Home<iconify-icon icon="fe:arrow-down" width="24"
                                            height="24"></iconify-icon></a></li>
                                <li><a class="active1" href="./shop.html">Shop<iconify-icon icon="fe:arrow-down"
                                            width="24" height="24"></iconify-icon></a></li>
                                <li><a href="./Details.html">Details<iconify-icon icon="fe:arrow-down" width="24"
                                            height="24"></iconify-icon></a></li>
                                <li><a href="./16_Checkout.html">Checkout<iconify-icon icon="fe:arrow-down"
                                            width="24" height="24"></iconify-icon></a></li>
                                <li><a href="">About Us</a></li>
                                <li><a href="">Contact Us</a></li>
                            </ul>
        ...
        <section id="register">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <form  action="{{ route('customer.register.submit') }}" id="signupForm"  method="POST">
                        @csrf
   ...
   <div class="row my-3">
    ...
    {{-- <script src="{{ asset('backendstyle/js/register.js') }}"></script> --}}
</body>
