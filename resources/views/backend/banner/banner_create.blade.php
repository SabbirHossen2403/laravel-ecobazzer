...
@section('conten')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action=" {{ route('backend.banner.banner_store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mt-5 mb-5">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mt-1" name="banner_title" id="title"
