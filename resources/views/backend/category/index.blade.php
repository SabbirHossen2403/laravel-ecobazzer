   ...
   <div>
     ...
     <div class="dropdown-menu w-40">
         <ul class="dropdown-content">
             ...
             <li> <a href="{{ route('backend.category.edit', $category->id) }}" class="dropdown-item"> <i data-feather="edit" class="w-4 h-4 text-gray-700 dark-text-gray-300 me-2"></i> Edit </a> </li>
             <li> <a href="" class="dropdown-item"> <i data-feather="trash" class="w-4 h-4 text-gray-700 dark-text-gray-300 me-2"></i>  Delete </a> </li>
             <li> <a href="" class="dropdown-item"> <i data-feather="archive" class="w-4 h-4 text-gray-700 dark-text-gray-300 me-2"></i> PDF </a> </li>
         </ul>
     </div>
 </div> </td>
            </tr>  
