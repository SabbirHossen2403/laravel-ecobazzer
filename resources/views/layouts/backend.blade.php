...
<html lang="en" class="light">
    ...
    <head>
        <meta charset="utf-8">
        <link href="{{asset('backendstyle/css/dist/images/logo.svg') }}" rel="shortcut icon">
        ...
        <div class="mobile-menu d-md-none">
            <div class="mobile-menu-bar">
                <a href="index.html" class="d-flex me-auto">
                    <img alt="Rubick Bootstrap HTML Admin Template" class="w-6" src="{{ asset('backendstyle/css/dist/images/logo.svg') }}">
                </a>
            ...
            <nav class="side-nav">
                <a href="{{ url('/') }}" class="intro-x d-flex align-items-center ps-5 pt-4">
                    <img style="filter: grayscale(100%) invert(100%) brightness(200%)" 
                     src="{{ asset('frontendstyle/images/Logo (1).png') }}" alt="">
                </a>
